export default {
  ...
  computed: {
    getDateArray() {
      let return_data;
      //获取当前月份有多少天
      let getDayNum = (month = this.checked_date.month, year = this.checked_date.year) => {
        //1.先看月份
        let return_data = 0;
      ...
      //判断是否为闰年
      let isLeapYear = (year = this.checked_date.year) => {
        //如果是二月份再看年份
      ...
      //获取第一天是星期几
      let getFirstDay = (month = this.checked_date.month, year = this.checked_date.year) => {
        //时间格式如"2014-04-23"
      ...
      //获取最后一天是礼拜几
      let getLastDay = (month = this.checked_date.month, year = this.checked_date.year) => {
      ...
      let getDateArray = (month = this.checked_date.month, year = this.checked_date.year, sort_way = this.checked_date.sort_way) => {
